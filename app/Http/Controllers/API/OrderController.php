...
class OrderController extends Controller
{
    ...
    protected static function rules4saveOrder(): array
    {
        return [
            ...
            'from_city_id'   => 'sometimes|required|integer|exists:cities,id,country_id,' . request('from_country_id',  0),
            'to_country_id'  => 'required|integer|exists:countries,id',
            'to_city_id'     => 'sometimes|required|integer|exists:cities,id,country_id,' . request('to_country_id', 0),
