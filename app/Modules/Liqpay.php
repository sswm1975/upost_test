...
class Liqpay
{
     ...
     * @return array
     */
    public static function create_params(int $user_id, string $user_name, int $job_id, float $amount, string $currency, string $description = ''): array
    {
        ...
        $params = [
            ...
            'language'         => app()->getLocale(),                # Язык клиента ru, uk, en.
