...
return [
    ...
    'custom' => [
        ...
        'order_text' => [
            'censor' => 'В заказе есть неприличные слова.',
    ...
    'attributes'           => [
        ...
        'order_from_country' => 'Город (откуда)',
        'order_id' => 'Код заказа',
        'order_name' => 'Наименование заказа',
        'order_price' => 'Цена заказа',
        'order_price_usd' => 'Цена заказа (в долларах)',
        'order_product_link' => 'Ссылка на товар',
        'order_size' => 'Размер',
        'order_text' => 'Описание',
        'order_weight' => 'Вес',
        'page' => 'Страница',
        ...
        'rate_deadline' => 'Дата окончания',
        'rate_id' => 'Код ставки',
        'rate_price' => 'Цена ставки',
        'rate_text' => 'Текст ставки',
        'rate_type' => 'Тип ставки',
        'rating' => 'Рейтинг',
        'remove_photo' => 'Признак удаления фото',
        'route_end' => 'Дата окончания',
        'route_from_city' => 'Город (откуда)',
        'route_from_country' => 'Страна (откуда)',
        'route_id' => 'Код маршрута',
        'route_start' => 'Дата начала',
        'route_to_city' => 'Город (куда)',
        'route_to_country' => 'Страна (куда)',
        'route_transport' => 'Тип транспорта',
        'show' => 'Показывать',
        'sort' => 'Сортировка',
        'status' => 'Статус',
        ...
        'user_card_name' => 'Наименование на платежной карте',
        'user_card_number' => 'Номер платежной карты',
        'user_city' => 'Город',
