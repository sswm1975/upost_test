...
return [
    ...
    'custom' => [
        ...
        'phone' => [
            'phone' => 'Номер телефона нужно заполнить в международном формате: символ плюс (+), код страны, кода региона, номер абонента.',
        ],
        'card_number' => [
            'bankcard' => 'Номер карты неверный.',
        ],
        'rate_id' => [
            'owner_rate' => 'У вас нет разрешения.',
        ],
        'resume' => [
            'censor' => 'В резюме есть нецензурные выражения.',
            'not_phone' => 'Запрещено оставлять контактные данные в резюме.',
        ],
        'text' => [
            'censor' => 'В тексте есть неприличные слова.',
            'not_phone' => 'Запрещено оставлять контактные данные в заказе.',
        ],
        'description' => [
            'not_phone' => 'В описании запрещены контактные данные.',
            'censor' => 'В описании есть неприличные слова.',
        ],
        'from_city' => [
            'city_name' => 'Название города "Откуда" неверно.',
        ],
        'to_city' => [
            'city_name' => 'Название города "Куда" неверно.',
        ],
    ],
    ...
    'attributes'           => [
        ...
        'card_name' => 'Наименование на платежной карте',
        'card_number' => 'Номер платежной карты',
        'card_exp_month' => 'Месяц окончания действия платежной карты',
        'card_exp_year' => 'Год окончания действия платежной карты',
        'card_cvc' => 'CVC-код платежной карты',
        'category' => 'Категория',
        'chat_id' => 'Код чата',
        'city' => 'Город',
        'city_id' => 'Город',
        'city_from' => 'Город (откуда)',
        'city_to' => 'Город (куда)',
        'city_to_id' => 'Город (куда)',
        'comment' => 'Комментарий',
        'content' => 'Контент',
        'count' => 'Количество',
        'country' => 'Страна',
        'country_from' => 'Страна (откуда)',
        'country_from_id' => 'Страна (откуда)',
        'country_to' => 'Страна (куда)',
        'currency' => 'Валюта',
        'user_price_usd' => 'Цена доставки',
        ...
        'email' => 'E-Mail адрес',
        'tilldate' => 'Дата окончания',
        'excerpt' => 'Выдержка',
        'files' => 'Файлы',
        'first_name' => 'Имя',
        'from_region' => 'Штат (откуда)',
        'from_city' => 'Город (откуда)',
        'from_city_id' => 'Город (откуда)',
        'from_country' => 'Город (откуда)',
        'from_country_id' => 'Страна (откуда)',
        ...
        'photos' => 'Фото',
        'price' => 'Цена',
        'price_usd' => 'Цена заказа (в долларах)',
        'problem_id' => 'Код проблемы',
        'product_link' => 'Ссылка на товар',
        'rating' => 'Рейтинг',
        'remove_photo' => 'Признак удаления фото',
        'resume' => 'Резюме/Биография',
        ...
        'start' => 'Дата начала',
        'status' => 'Статус',
        'strike_id' => 'Код жалобы',
        'surname' => 'Фамилия',
        'text' => 'Описание',
        'time' => 'Время',
        'title' => 'Наименование',
        'to_city' => 'Город (куда)',
        'to_country' => 'Страна (куда)',
        'to_user' => 'Пользователь',
        'token' => 'Токен',
