...
return [
    ...
    'custom' => [
        ...
        'phone' => [
            'phone' => 'Номер телефону потрібно заповнити в міжнародному форматі: символ «плюс» (+), код країни, коду регіону, номер абонента.',
        ],
        'card_number' => [
        ...
        'description' => [
            'not_phone' => 'В описі заборонено контактні дані.',
            'censor' => 'В описі є непристойні слова.',
        ],
        'from_city' => [
            'city_name' => 'Назва міста «Звідки» неправильна.',
        ],
        'to_city' => [
            'city_name' => 'Назва міста "Куди" невірна.',
        ],
    ],
    ...
    'attributes'           => [
        ...
        'card_exp_month' => 'Місяц закінчення дії картки',
        'card_exp_year' => 'Рік закінчення дії картки',
        'card_cvc' => 'CVC-код на платіжній картці',
        'category' => 'Категорія',
        'chat_id' => 'Код чату',
        'city' => 'Місто',
        'city_id' => 'Місто',
