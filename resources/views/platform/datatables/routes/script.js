...
var table = $('#orders').DataTable({
    ...
    columnDefs: [
        ...
        { targets: [13], searchBuilderTitle: 'Цена $' },
        { targets: [14], searchBuilderTitle: 'Цена ком.' },
        { targets: [15], searchBuilderTitle: 'Дата доставки' },
        { targets: [16], searchBuilderTitle: 'Дата создания' },
        { targets: [17], searchBuilderTitle: 'Дата изменения' },
    ],
    columns: [
