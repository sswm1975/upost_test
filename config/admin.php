...
return [
    ...
    */
    ...
    |
    */
    'bootstrap' => app_path('Platform/bootstrap.php'),
    ...
    */
    ...
    |
    */
    'title' => env('APP_NAME', 'Laravel') . '-Admin',
    ...
    */
    'login_background_image' => [
        '/img/login_background_1.jpg',
        '/img/login_background_2.jpg',
        '/img/login_background_3.jpg',
        '/img/login_background_4.jpg',
        '/img/login_background_5.jpg',
    ],
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Enable/Disable sidebar user panel
    |--------------------------------------------------------------------------
    */
...
//    'grid_action_class' => \Encore\Admin\Grid\Displayers\DropdownActions::class,
    ...
    */
    'extension_dir' => app_path('Platform/Extensions'),
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Full path to bin php.
    |--------------------------------------------------------------------------
    |
    | Full path to bin php.
    */
    'php' => env('ADMIN_PHP', 'php'),
];
